...
class AzureProvisioner(AnsibleDriver):
    ...
    def _readClusterSettings(self):
        ...
        self._mainPublicKeyFile =  self.LEADER_HOME_DIR + '.ssh/id_rsa.pub'
    ...
    def launchCluster(self, leaderNodeType, leaderStorage, owner, **kwargs):
        ...
        """
        self._owner = owner
        self._mainPublicKeyFile = kwargs['publicKeyFile']
        if not self._mainPublicKeyFile:
        ...
        ansibleArgs = {
            ...
            'publickeyfile': self._mainPublicKeyFile   # The users public key to be added to authorized_keys
        }
    ...
    def addNodes(self, nodeType, numNodes, preemptable=False, spotBid=None):
        ...
        ansibleArgs = dict(vmsize=nodeType,
                           ...
                           owner=self._owner,
                           role="worker",
                           publickeyfile=self._mainPublicKeyFile)
        with tempfile.NamedTemporaryFile(delete=False) as t:
