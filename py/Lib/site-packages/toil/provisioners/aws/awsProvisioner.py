...
class AWSProvisioner(AbstractProvisioner):
    ...
    def _readClusterSettings(self):
        ...
        self._mainPublicKey = self._setSSH()
    ...
    def launchCluster(self, leaderNodeType, leaderStorage, owner, **kwargs):
        ...
        self._mainPublicKey = 'AAAAB3NzaC1yc2Enoauthorizedkeyneeded' # dummy key
        userData =  self._getCloudConfigUserData('leader', self._mainPublicKey)
    ...
    def addNodes(self, nodeType, numNodes, preemptable, spotBid=None):
        ...
        userData =  self._getCloudConfigUserData('worker', self._mainPublicKey, keyPath, preemptable)
