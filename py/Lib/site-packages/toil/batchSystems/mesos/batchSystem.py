...
class MesosBatchSystem(BatchSystemLocalSupport,
    ...
    def __init__(self, config, maxCores, maxMemory, maxDisk):
        ...
        # The string framework ID that we are assigned when registering with the Mesos main
    ...
    def _handleFailedExecutor(self, agentID, executorID=None):
        ...
        try:
            ...
            if '/subordinate/log' not in agentLogFilenames:
                # Look here even if not reported.
                agentLogFilenames.append('/subordinate/log')
