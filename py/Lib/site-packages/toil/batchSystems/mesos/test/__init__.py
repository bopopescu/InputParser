...
class MesosTestSupport(object):
    """
    A mixin for test cases that need a running Mesos main and agent on the local host
    """
    ...
    def _startMesos(self, numCores=None):
        ...
        # Wait for the main to come up.
        # Bad Things will happen if the main is not yet ready when Toil tries to use it.
    ...
    def _stopMesos(self):
        ...
        self.agent.join()
        self._stopProcess(self.main.popen)
        self.main.join()
    ...
    class MesosAgentThread(MesosThread):
        def mesosCommand(self):
            ...
            return [self.findMesosBinary(['mesos-agent', 'mesos-subordinate']),
                    '--ip=127.0.0.1',
                    '--main=127.0.0.1:5050',
