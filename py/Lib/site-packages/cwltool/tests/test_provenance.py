...
def check_prov(base_path, nested=False, single_tool=False, directory=False,
    ...
    assert (main_run, PROV.wasAssociatedWith, engine) in g, "Wf run not associated with wf engine"
    ...
    if single_tool:
        ...
        for step in stepActivities:
            ...
            start = starts.pop()
            assert (start, PROV.hadActivity, main_run) in g,\
                "Step activity not started by main activity"
