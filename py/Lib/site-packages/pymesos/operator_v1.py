...
class MesosOperatorDaemonDriver(OperatorDaemonDriver):
    ...
    def init(self, daemon_uri):
        """
        :param daemon_uri: mainHost:5050 or agentHost:5051
        """
...
class MesosOperatorMainDriver(Process, MesosOperatorDaemonDriver):
    def __init__(self, main_uri, operator=None, use_addict=False,
                 timeout=DAY):
        """
        ...
        :type operator: OperatorMain
        """
        super(MesosOperatorMainDriver, self).__init__(main=main_uri,
                                                        timeout=timeout)
        super(MesosOperatorMainDriver, self).init(main_uri)
        self.operator = operator
        self.main_uri = main_uri
        self._dict_cls = Dict if use_addict else dict

    def start(self):
        super(MesosOperatorMainDriver, self).start()
        uri = self.main_uri
